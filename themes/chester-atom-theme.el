;;; chester-atom-theme.el --- Chester Atom Theme
...
;; URL: https://github.com/ndethore/emacs-chester-atom
...
(let ((class '((class color) (min-colors 89)))
      ...
      (fg3 "#ccccc7")
      (fg4 "#b6b6b2")
      (bg1 "#2c3643") ;; (bg1 "#282a36")
      (bg2 "#373844")
      (bg3 "#222a34") ;; (bg3 "#464752")
      (bg4 "#99a9b3") ;; (bg4 "#565761")
      (bg5 "#44475a")
      (key2 "#0189cc")
      (key3 "#ff79c6")
      (builtin "#ffc83f") ;; (builtin "#ffb86c")
      (keyword "#89bde4") ;; (keyword "#ff79c6")
      (const   "#fa5e5b") ;; (const   "#8be9fd")
      (comment "#99a9b3") ;; (comment "#6272a4")
      (func    "#288ad6") ;; (func    "#50fa7b")
      (str     "#16c98d") ;; (str     "#f1fa8c")
      (type    "#bd93f9")
      (var     "#fa5e5b") ;; (var     "#f8f8f2")
      (warning "#ffb86c")
      (rainbow-1 "#f8f8f2")
      (rainbow-2 "#8be9fd")
      (rainbow-3 "#bd93f9")
...
(provide-theme 'chester-atom)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; chester-atom-theme.el ends here
